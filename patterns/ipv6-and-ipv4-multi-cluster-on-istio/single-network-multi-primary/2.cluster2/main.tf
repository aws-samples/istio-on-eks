...
resource "kubernetes_secret" "cacerts" {
  ...
  data = {
    "ca-cert.pem"    = file("/Users/gouannem/Desktop/istio-multi-cluster/0.certs-tool/certs/cluster-2/ca-cert.pem")
    "ca-key.pem"     = file("/Users/gouannem/Desktop/istio-multi-cluster/0.certs-tool/certs/cluster-2/ca-key.pem")
    "root-cert.pem"  = file("/Users/gouannem/Desktop/istio-multi-cluster/0.certs-tool/certs/cluster-2/root-cert.pem")
    "cert-chain.pem" = file("/Users/gouannem/Desktop/istio-multi-cluster/0.certs-tool/certs/cluster-2/cert-chain.pem")
  }
}
