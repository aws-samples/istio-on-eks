...
module "vpc_2" {
  ...
  # IPv6 settings
  enable_ipv6            = local.eks_2_IPv6
  create_egress_only_igw = local.eks_2_IPv6

  public_subnet_ipv6_prefixes                    = local.eks_2_IPv6 == true ? [0, 1, 2] : []
  public_subnet_assign_ipv6_address_on_creation  = local.eks_2_IPv6
  private_subnet_ipv6_prefixes                   = local.eks_2_IPv6 == true ? [3, 4, 5] : []
  private_subnet_assign_ipv6_address_on_creation = local.eks_2_IPv6
