    ...
    cluster1_name = templatefile("${path.module}/istio-remote-secret.tftpl",
      {
        ...
        cluster_istio_reader_token         = data.terraform_remote_state.cluster2.outputs.istio_reader_token
      }
    )
  }
}
    ...
    cluster1_name = templatefile("${path.module}/istio-remote-secret.tftpl",
      {
        ...
        cluster_istio_reader_token         = data.terraform_remote_state.cluster1.outputs.istio_reader_token
      }
    )
  }
}
